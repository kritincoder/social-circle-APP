...
function publicUser(user) {
  return { id: user.id, username: user.username, email: user.email, displayName: user.display_name, display_name: user.display_name, name: user.display_name, bio: user.bio || '', profilePhotoUrl: user.profile_photo_url || null, isAdmin: !!user.is_admin };
}
